    ...
    <footer id="contact" className="bg-muted/30 border-t">
      <div className="container mx-auto py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <img src="\GSI_LOGO.png" alt="Logo" className="h-20 rounded-md" />
              {/* <span className="text-xl font-bold">Savoria</span> */}
            </div>
            <p className="text-sm text-muted-foreground mb-4">
              Grace Mission International is an NGO and charitable trust dedicated to empowering individuals and fostering self-sufficiency. Driven by compassion and social justice, our mission is to uplift the most vulnerable, creating a future where everyone can thrive.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/#initiatives" className="text-muted-foreground hover:text-foreground">
                  Our Initiatives
                </a>
              </li>
              <li>
        ...
        <div className="border-t mt-12 pt-6 text-center text-sm text-muted-foreground">
          <p>Copyright &copy; {new Date().getFullYear()} Grace Mission International. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
