...
const Form = ({ title, subtitle }) => {
  ...
  return (
    <>
      <div className="max-w-3xl mx-auto" id='formHeading'>
        ...
        {(!dataSend)
          ? <div className=" bg-[#000000] rounded-2xl shadow-xl p-8 md:p-10 text-black">
            <form className="space-y-8" onSubmit={onSubmitButton} role="form">
              ...
              {/* Country */}
              <div>
                <label htmlFor="form-country" className="block text-lg font-semibold text-gray-100 mb-3">
                  Your Country
                </label>
                <div className="relative">
                  <input
              ...
              {/* Message */}
              <div>
                <label htmlFor="form-message" className="block text-lg font-semibold text-gray-100 mb-3">
                  Your Message
                </label>
                <div className="relative">
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-4 text-lg border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 focus:outline-none transition-all duration-200 placeholder-gray-400 resize-none"
                    required
                  />
